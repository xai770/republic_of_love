...
# ty_learn Workspace Reorganization Script (No Backup Version)
...
create_new_structure() {
    ...
    mkdir -p archive_consolidated/{legacy_versions,old_experiments,deprecated_configs,migration_logs}
...
migrate_production() {
    ...
    if [ -d "modules/ty_extract_versions/ty_extract_PROD" ]; then
        ...
        cp -r modules/ty_extract_versions/ty_extract_PROD/* active_production/sandy_pipeline/ 2>/dev/null || warn "Some files may not have moved"
...
migrate_development() {
    ...
    if [ -d "experiments/v15_experimental" ]; then
        ...
        mv experiments/v15_experimental/ archive_consolidated/old_experiments/
    fi
...
**Date**: $(date)
**Backup Location**: /home/xai/Documents_archive/ty_learn
**Log File**: $LOG_FILE
...
- \`archive_consolidated/\` - Historical materials
...
Full backup created at: /home/xai/Documents_archive/ty_learn

To restore if needed:
\`\`\`bash
rm -rf /home/xai/Documents/ty_learn
cp -r /home/xai/Documents_archive/ty_learn /home/xai/Documents/
\`\`\`
...
main() {
    ...
    log "🛡️ Backup already exists at: /home/xai/Documents_archive/ty_learn"
    ...
    log "🛡️ Backup available at: /home/xai/Documents_archive/ty_learn"
