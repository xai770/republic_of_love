...
\restrict roRJHk9PEgSUjZ5uXumDXexUf2he4ueaboR1zzOSZs9fdYrg5MIJ3cxUXfYKic3
...
COMMENT ON TABLE public.skill_aliases IS 'DEPRECATED: Use entities + entity_aliases. Kept for FK compatibility during migration.';
...
--
-- Name: skill_entity_map; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.skill_entity_map (
    skill_id integer NOT NULL,
    entity_id integer NOT NULL,
    skill_name text NOT NULL,
...
ALTER TABLE public.skill_entity_map OWNER TO postgres;
...
COMMENT ON TABLE public.skill_hierarchy IS 'DEPRECATED: Use entity_relationships. Kept for reference.';
...
--
-- Name: skill_hierarchy_backup_20251205_094228; Type: TABLE; Schema: public; Owner: base_admin
--

CREATE TABLE public.skill_hierarchy_backup_20251205_094228 (
...
ALTER TABLE public.skill_hierarchy_backup_20251205_094228 OWNER TO base_admin;
...
COMMENT ON TABLE public.skill_occurrences IS 'DEPRECATED: Use entity-based tracking.';
...
--
-- Name: v_skill_aliases; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.v_skill_aliases AS
 SELECT sem.skill_id,
    e.canonical_name AS skill_name,
    en.display_name,
    ea.alias AS skill_alias,
    en.confidence,
    COALESCE(en.language, 'en'::text) AS language,
    e.created_at,
    e.created_by,
    NULL::text AS notes
   FROM (((public.skill_entity_map sem
     JOIN public.entities e ON ((sem.entity_id = e.entity_id)))
     LEFT JOIN public.entity_names en ON (((e.entity_id = en.entity_id) AND (en.is_primary = true))))
     LEFT JOIN public.entity_aliases ea ON ((e.entity_id = ea.entity_id)));


ALTER TABLE public.v_skill_aliases OWNER TO postgres;

--
-- Name: v_skill_hierarchy; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.v_skill_hierarchy AS
 SELECT child_map.skill_id,
   ...
   FROM ((public.entity_relationships er
     JOIN public.skill_entity_map child_map ON ((er.entity_id = child_map.entity_id)))
     JOIN public.skill_entity_map parent_map ON ((er.related_entity_id = parent_map.entity_id)))
  WHERE (er.relationship = 'child_of'::text);


ALTER TABLE public.v_skill_hierarchy OWNER TO postgres;
...
--
-- Name: skill_entity_map skill_entity_map_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.skill_entity_map
    ADD CONSTRAINT skill_entity_map_pkey PRIMARY KEY (skill_id);
...
ALTER TABLE ONLY public.skill_hierarchy
    ADD CONSTRAINT skill_hierarchy_pkey PRIMARY KEY (skill_id);
...
GRANT SELECT ON TABLE public.entities TO base_admin;
...
GRANT SELECT ON TABLE public.entity_aliases TO base_admin;
...
GRANT SELECT,INSERT,UPDATE ON TABLE public.registry_decisions TO base_admin;
...
--
-- Name: TABLE skill_entity_map; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.skill_entity_map TO base_admin;
...
\unrestrict roRJHk9PEgSUjZ5uXumDXexUf2he4ueaboR1zzOSZs9fdYrg5MIJ3cxUXfYKic3
