...
\restrict wat93AWXdLOimeKNVcgWEyazg42fWtDKQ1kGQpDW5MsE26wv8XRRTYANfr5oDoY
...
--
-- Name: skill_aliases_final; Type: TABLE; Schema: archive; Owner: postgres
--
...
ALTER TABLE archive.skill_aliases_final OWNER TO postgres;

--
-- Name: skill_entity_map_final; Type: TABLE; Schema: archive; Owner: postgres
--
...
ALTER TABLE archive.skill_entity_map_final OWNER TO postgres;

--
-- Name: skill_hierarchy_final; Type: TABLE; Schema: archive; Owner: postgres
--
...
ALTER TABLE archive.skill_hierarchy_final OWNER TO postgres;

--
-- Name: skill_occurrences_final; Type: TABLE; Schema: archive; Owner: postgres
--
...
ALTER TABLE archive.skill_occurrences_final OWNER TO postgres;

--
-- Name: skills_pending_taxonomy_final; Type: TABLE; Schema: archive; Owner: postgres
--
...
ALTER TABLE archive.skills_pending_taxonomy_final OWNER TO postgres;
...
CREATE TABLE public.entities (
    ...
    CONSTRAINT entities_status_check CHECK ((status = ANY (ARRAY['active'::text, 'deprecated'::text, 'merged'::text])))
);
...
COMMENT ON TABLE public.entities IS 'Universal registry of things that exist - skills, places, concepts';


--
-- Name: COLUMN entities.canonical_name; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.entities.canonical_name IS 'The One True Name - never displayed, only referenced internally';


--
-- Name: COLUMN entities.status; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.entities.status IS 'Lifecycle: active (normal), deprecated (historical), merged (redirects to merged_into)';


--
-- Name: COLUMN entities.metadata; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.entities.metadata IS 'Type-specific data: {"iso_code": "DE"} for countries, {"coordinates": [lat, lon]} for cities';
...
--
-- Name: entities_pending; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.entities_pending (
    ...
    processed_by text,
    CONSTRAINT entities_pending_check CHECK (((status = 'pending'::text) OR (processed_at IS NOT NULL))),
    CONSTRAINT entities_pending_status_check CHECK ((status = ANY (ARRAY['pending'::text, 'approved'::text, 'rejected'::text, 'merged'::text])))
);


ALTER TABLE public.entities_pending OWNER TO postgres;

--
-- Name: TABLE entities_pending; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.entities_pending IS 'Unresolved entity references awaiting human/AI classification';


--
-- Name: COLUMN entities_pending.raw_value; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.entities_pending.raw_value IS 'Exact text received - may be misspelled, foreign language, etc.';


--
-- Name: COLUMN entities_pending.source_context; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.entities_pending.source_context IS 'Provenance: where did this come from?';


--
-- Name: entities_pending_pending_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.entities_pending_pending_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.entities_pending_pending_id_seq OWNER TO postgres;

--
-- Name: entities_pending_pending_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.entities_pending_pending_id_seq OWNED BY public.entities_pending.pending_id;


--
-- Name: entity_alias_reviews; Type: TABLE; Schema: public; Owner: base_admin
--

CREATE TABLE public.entity_alias_reviews (
    ...
    CONSTRAINT entity_alias_reviews_action_check CHECK (((action)::text = ANY ((ARRAY['approve'::character varying, 'reject'::character varying, 'remap'::character varying, 'delete'::character varying])::text[])))
);


ALTER TABLE public.entity_alias_reviews OWNER TO base_admin;

--
-- Name: entity_alias_reviews_review_id_seq; Type: SEQUENCE; Schema: public; Owner: base_admin
--

CREATE SEQUENCE public.entity_alias_reviews_review_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.entity_alias_reviews_review_id_seq OWNER TO base_admin;

--
-- Name: entity_alias_reviews_review_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: base_admin
--

ALTER SEQUENCE public.entity_alias_reviews_review_id_seq OWNED BY public.entity_alias_reviews.review_id;
...
CREATE TABLE public.entity_aliases (
    ...
    alias_type text DEFAULT 'standard'::text,
    ...
    deleted_reason text,
    CONSTRAINT entity_aliases_confidence_check CHECK (((confidence >= (0)::numeric) AND (confidence <= (1)::numeric)))
);
...
--
-- Name: TABLE entity_aliases; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.entity_aliases IS 'Alternative names, abbreviations, misspellings that resolve to entities';


--
-- Name: COLUMN entity_aliases.alias_type; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.entity_aliases.alias_type IS 'Why this alias exists - helps with matching confidence';


--
-- Name: entity_aliases_alias_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.entity_aliases_alias_id_seq OWNER TO postgres;

--
-- Name: entity_aliases_alias_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE entity_names; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.entity_names IS 'How entities are displayed to humans, by language';


--
-- Name: COLUMN entity_names.is_primary; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.entity_names.is_primary IS 'If true, this is THE name to show for this entity in this language';


--
-- Name: COLUMN entity_names.confidence; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.entity_names.confidence IS 'Translation confidence: 1.0 = verified, 0.8 = LLM suggested, etc.';
...
CREATE TABLE public.entity_relationships (
    ...
    provenance jsonb,
    is_primary boolean DEFAULT false,
    CONSTRAINT entity_relationships_check CHECK ((entity_id <> related_entity_id)),
...
--
-- Name: TABLE entity_relationships; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN entity_relationships.relationship; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.entity_relationships.relationship IS 'is_a (taxonomy), located_in (geography), part_of (composition), same_as (identity), related_to (loose)';
...
--
-- Name: COLUMN interactions.failure_type; Type: COMMENT; Schema: public; Owner: base_admin
--

COMMENT ON COLUMN public.interactions.failure_type IS 'Classification: timeout, interrupted, rate_limit, api_error, parse_error, invalid_output, script_error, unknown';
...
--
-- Name: qa_runs; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.qa_runs (
    ...
    notes text,
    workflow_run_id integer,
    CONSTRAINT qa_runs_run_type_check CHECK ((run_type = ANY (ARRAY['discovery'::text, 'regression'::text, 'manual'::text]))),
    CONSTRAINT qa_runs_status_check CHECK ((status = ANY (ARRAY['running'::text, 'completed'::text, 'failed'::text, 'reviewed'::text, 'closed'::text])))
);


ALTER TABLE public.qa_runs OWNER TO postgres;

--
-- Name: qa_runs_run_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.qa_runs_run_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.qa_runs_run_id_seq OWNER TO postgres;

--
-- Name: qa_runs_run_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.qa_runs_run_id_seq OWNED BY public.qa_runs.run_id;
...
--
-- Name: registry_decisions; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.registry_decisions (
...
ALTER TABLE public.registry_decisions OWNER TO postgres;

--
-- Name: TABLE registry_decisions; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.registry_decisions IS 'Audit trail for all registry modifications - enables RAQ (Repeatability, Auditability, QA)';


--
-- Name: registry_decisions_decision_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.registry_decisions_decision_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.registry_decisions_decision_id_seq OWNER TO postgres;

--
-- Name: registry_decisions_decision_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.registry_decisions_decision_id_seq OWNED BY public.registry_decisions.decision_id;
...
--
-- Name: v_entity_display; Type: VIEW; Schema: public; Owner: postgres
--
...
CREATE VIEW public.v_entity_display AS
 SELECT e.entity_id,
   ...
   FROM ((public.entities e
     LEFT JOIN public.entity_names n ON (((e.entity_id = n.entity_id) AND (n.is_primary = true))))
     LEFT JOIN public.entity_names n_en ON (((e.entity_id = n_en.entity_id) AND (n_en.language = 'en'::text) AND (n_en.is_primary = true))))
  WHERE (e.status = 'active'::text);


ALTER TABLE public.v_entity_display OWNER TO postgres;

--
-- Name: VIEW v_entity_display; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: entities_pending pending_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.entities_pending ALTER COLUMN pending_id SET DEFAULT nextval('public.entities_pending_pending_id_seq'::regclass);


--
-- Name: entity_alias_reviews review_id; Type: DEFAULT; Schema: public; Owner: base_admin
--

ALTER TABLE ONLY public.entity_alias_reviews ALTER COLUMN review_id SET DEFAULT nextval('public.entity_alias_reviews_review_id_seq'::regclass);


--
-- Name: entity_aliases alias_id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: qa_runs run_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.qa_runs ALTER COLUMN run_id SET DEFAULT nextval('public.qa_runs_run_id_seq'::regclass);


--
-- Name: registry_decisions decision_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.registry_decisions ALTER COLUMN decision_id SET DEFAULT nextval('public.registry_decisions_decision_id_seq'::regclass);
...
--
-- Name: entities entities_entity_type_canonical_name_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: entities_pending entities_pending_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.entities_pending
    ADD CONSTRAINT entities_pending_pkey PRIMARY KEY (pending_id);
...
--
-- Name: entity_alias_reviews entity_alias_reviews_pkey; Type: CONSTRAINT; Schema: public; Owner: base_admin
--

ALTER TABLE ONLY public.entity_alias_reviews
    ADD CONSTRAINT entity_alias_reviews_pkey PRIMARY KEY (review_id);


--
-- Name: entity_aliases entity_aliases_alias_language_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.entity_aliases
    ADD CONSTRAINT entity_aliases_alias_language_key UNIQUE (alias, language);
...
ALTER TABLE ONLY public.entity_names
    ADD CONSTRAINT entity_names_pkey PRIMARY KEY (entity_id, language, display_name);
...
ALTER TABLE ONLY public.entity_relationships
    ADD CONSTRAINT entity_relationships_pkey PRIMARY KEY (entity_id, related_entity_id, relationship);
...
--
-- Name: qa_runs qa_runs_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: registry_decisions registry_decisions_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.registry_decisions
    ADD CONSTRAINT registry_decisions_pkey PRIMARY KEY (decision_id);
...
--
-- Name: idx_alias_reviews_alias; Type: INDEX; Schema: public; Owner: base_admin
--

CREATE INDEX idx_alias_reviews_alias ON public.entity_alias_reviews USING btree (alias_id);


--
-- Name: idx_alias_reviews_pending; Type: INDEX; Schema: public; Owner: base_admin
--

CREATE INDEX idx_alias_reviews_pending ON public.entity_alias_reviews USING btree (applied_at) WHERE (applied_at IS NULL);
...
--
-- Name: idx_entities_canonical_lower_unique; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX idx_entities_canonical_lower_unique ON public.entities USING btree (lower(canonical_name), entity_type) WHERE (status = 'active'::text);


--
-- Name: idx_entities_merged; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_entities_merged ON public.entities USING btree (merged_into_entity_id) WHERE (merged_into_entity_id IS NOT NULL);


--
-- Name: idx_entities_pending_status; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_entities_pending_status ON public.entities_pending USING btree (status) WHERE (status = 'pending'::text);


--
-- Name: idx_entities_pending_type; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_entities_pending_type ON public.entities_pending USING btree (entity_type, status);


--
-- Name: idx_entities_pending_unique; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX idx_entities_pending_unique ON public.entities_pending USING btree (entity_type, raw_value);


--
-- Name: idx_entities_status; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_entities_status ON public.entities USING btree (status) WHERE (status <> 'active'::text);
...
--
-- Name: idx_entity_aliases_entity; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_entity_aliases_lookup; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_entity_aliases_lookup ON public.entity_aliases USING btree (lower(alias), language);


--
-- Name: idx_entity_names_lookup; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_entity_names_lookup ON public.entity_names USING btree (display_name, language);


--
-- Name: idx_entity_names_primary; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_entity_names_primary ON public.entity_names USING btree (entity_id, language) WHERE (is_primary = true);


--
-- Name: idx_entity_relationships_related; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_entity_relationships_related ON public.entity_relationships USING btree (related_entity_id);


--
-- Name: idx_entity_relationships_type; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_entity_relationships_type ON public.entity_relationships USING btree (relationship);
...
--
-- Name: idx_posting_skills_entity_id; Type: INDEX; Schema: public; Owner: base_admin
--

CREATE INDEX idx_posting_skills_entity_id ON public.posting_skills USING btree (entity_id);


--
-- Name: idx_posting_skills_entity_unique; Type: INDEX; Schema: public; Owner: base_admin
--

CREATE UNIQUE INDEX idx_posting_skills_entity_unique ON public.posting_skills USING btree (posting_id, entity_id) WHERE (entity_id IS NOT NULL);
...
--
-- Name: idx_profile_skills_entity_id; Type: INDEX; Schema: public; Owner: base_admin
--

CREATE INDEX idx_profile_skills_entity_id ON public.profile_skills USING btree (entity_id);


--
-- Name: idx_profile_skills_entity_unique; Type: INDEX; Schema: public; Owner: base_admin
--

CREATE UNIQUE INDEX idx_profile_skills_entity_unique ON public.profile_skills USING btree (profile_id, entity_id) WHERE (entity_id IS NOT NULL);
...
--
-- Name: idx_qa_findings_interaction; Type: INDEX; Schema: public; Owner: base_admin
--

CREATE INDEX idx_qa_findings_interaction ON public.qa_findings USING btree (source_interaction_id) WHERE (source_interaction_id IS NOT NULL);
...
--
-- Name: idx_registry_decisions_status; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_registry_decisions_status ON public.registry_decisions USING btree (review_status);


--
-- Name: idx_registry_decisions_subject; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_registry_decisions_subject ON public.registry_decisions USING btree (subject_entity_id);


--
-- Name: idx_registry_decisions_type; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_registry_decisions_type ON public.registry_decisions USING btree (decision_type);
...
--
-- Name: entities entities_merged_into_entity_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.entities
    ADD CONSTRAINT entities_merged_into_entity_id_fkey FOREIGN KEY (merged_into_entity_id) REFERENCES public.entities(entity_id);


--
-- Name: entities_pending entities_pending_resolved_entity_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.entities_pending
    ADD CONSTRAINT entities_pending_resolved_entity_id_fkey FOREIGN KEY (resolved_entity_id) REFERENCES public.entities(entity_id);


--
-- Name: entity_aliases entity_aliases_entity_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
ALTER TABLE ONLY public.entity_names
    ADD CONSTRAINT entity_names_entity_id_fkey FOREIGN KEY (entity_id) REFERENCES public.entities(entity_id) ON DELETE CASCADE;


--
-- Name: entity_relationships entity_relationships_entity_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.entity_relationships
    ADD CONSTRAINT entity_relationships_entity_id_fkey FOREIGN KEY (entity_id) REFERENCES public.entities(entity_id) ON DELETE CASCADE;


--
-- Name: entity_relationships entity_relationships_related_entity_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.entity_relationships
    ADD CONSTRAINT entity_relationships_related_entity_id_fkey FOREIGN KEY (related_entity_id) REFERENCES public.entities(entity_id) ON DELETE CASCADE;
...
--
-- Name: posting_skills fk_posting_skills_entity_id; Type: FK CONSTRAINT; Schema: public; Owner: base_admin
--

ALTER TABLE ONLY public.posting_skills
    ADD CONSTRAINT fk_posting_skills_entity_id FOREIGN KEY (entity_id) REFERENCES public.entities(entity_id);


--
-- Name: profile_skills fk_profile_skills_entity_id; Type: FK CONSTRAINT; Schema: public; Owner: base_admin
--

ALTER TABLE ONLY public.profile_skills
    ADD CONSTRAINT fk_profile_skills_entity_id FOREIGN KEY (entity_id) REFERENCES public.entities(entity_id);
...
--
-- Name: qa_findings qa_findings_source_interaction_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: base_admin
--

ALTER TABLE ONLY public.qa_findings
    ADD CONSTRAINT qa_findings_source_interaction_id_fkey FOREIGN KEY (source_interaction_id) REFERENCES public.interactions(interaction_id);


--
-- Name: qa_runs qa_runs_workflow_run_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.qa_runs
    ADD CONSTRAINT qa_runs_workflow_run_id_fkey FOREIGN KEY (workflow_run_id) REFERENCES public.workflow_runs(workflow_run_id);


--
-- Name: registry_decisions registry_decisions_subject_entity_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.registry_decisions
    ADD CONSTRAINT registry_decisions_subject_entity_id_fkey FOREIGN KEY (subject_entity_id) REFERENCES public.entities(entity_id);


--
-- Name: registry_decisions registry_decisions_target_entity_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.registry_decisions
    ADD CONSTRAINT registry_decisions_target_entity_id_fkey FOREIGN KEY (target_entity_id) REFERENCES public.entities(entity_id);
...
--
-- Name: TABLE conversation_tag_definitions; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.conversation_tag_definitions TO base_admin;
...
GRANT ALL ON TABLE public.conversation_tags TO base_admin;
...
GRANT ALL ON TABLE public.entities TO base_admin;
...
GRANT SELECT,USAGE ON SEQUENCE public.entities_entity_id_seq TO base_admin;


--
-- Name: TABLE entities_pending; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.entities_pending TO base_admin;


--
-- Name: SEQUENCE entities_pending_pending_id_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT,USAGE ON SEQUENCE public.entities_pending_pending_id_seq TO base_admin;
...
GRANT SELECT,INSERT,REFERENCES,DELETE,UPDATE ON TABLE public.entity_aliases TO base_admin;


--
-- Name: SEQUENCE entity_aliases_alias_id_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT,USAGE ON SEQUENCE public.entity_aliases_alias_id_seq TO base_admin;
...
GRANT SELECT ON TABLE public.entity_names TO base_admin;


--
-- Name: TABLE entity_relationships; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.entity_relationships TO base_admin;
...
--
-- Name: TABLE registry_decisions; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.registry_decisions TO base_admin;


--
-- Name: SEQUENCE registry_decisions_decision_id_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT,USAGE ON SEQUENCE public.registry_decisions_decision_id_seq TO base_admin;
...
\unrestrict wat93AWXdLOimeKNVcgWEyazg42fWtDKQ1kGQpDW5MsE26wv8XRRTYANfr5oDoY
