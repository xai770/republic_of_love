...
-- SKIPPED (has database constraints):
-- actor_rate_control.rate_control_id - PRIMARY KEY
-- conversation_dialogue.dialogue_step_id - PRIMARY KEY
-- conversation_runs.workflow_step_id - IS FK to: workflow_conversations.step_id
-- conversation_runs.active_actor_id - IS FK to: actors.actor_id
-- instructions.delegate_actor_id - IS FK to: actors.actor_id
-- interaction_lineage.lineage_id - PRIMARY KEY
-- interaction_lineage.downstream_interaction_id - IS FK to: llm_interactions.interaction_id
-- interaction_lineage.upstream_interaction_id - IS FK to: llm_interactions.interaction_id
-- job_sources.fetch_workflow_id - IS FK to: workflows.workflow_id
-- organizations.organization_id - FK: users.organization_id -> organizations.organization_id, PRIMARY KEY
-- posting_field_mappings.mapping_id - PRIMARY KEY
-- posting_skills.posting_skill_id - PRIMARY KEY
-- posting_state_snapshots.snapshot_id - PRIMARY KEY
-- profile_education.education_id - PRIMARY KEY
-- profile_job_matches.match_id - PRIMARY KEY
-- profile_languages.language_id - PRIMARY KEY
-- profile_work_history.work_history_id - PRIMARY KEY
-- script_executions.script_id - IS FK to: stored_scripts.script_id
-- stored_scripts.script_id - FK: stored_scripts.replaces_script_id -> stored_scripts.script_id, FK: script_executions.script_id -> stored_scripts.script_id, PRIMARY KEY
-- stored_scripts.replaces_script_id - IS FK to: stored_scripts.script_id
-- user_posting_decisions.decision_id - PRIMARY KEY
-- user_posting_preferences.preference_id - PRIMARY KEY
-- users.organization_id - IS FK to: organizations.organization_id
-- workflow_conversations.depends_on_step_id - IS FK to: workflow_conversations.step_id
-- workflow_dependencies.dependency_id - PRIMARY KEY
-- workflow_dependencies.depends_on_workflow_id - IS FK to: workflows.workflow_id
-- workflow_errors.error_id - PRIMARY KEY
-- workflow_metrics.metric_id - PRIMARY KEY
-- workflow_step_metrics.metric_id - PRIMARY KEY

-- SKIPPED (used by views):
-- actors.is_production - used by: model_performance (last used: 2025-11-30)
-- actors.model_variant - used by: model_performance (last used: 2025-11-30)

-- Drop actor_rate_control.check_time (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: 2025-11-13 06:44:44.173133
ALTER TABLE "actor_rate_control" DROP COLUMN IF EXISTS "check_time";

-- Drop actor_rate_control.was_allowed (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: t
ALTER TABLE "actor_rate_control" DROP COLUMN IF EXISTS "was_allowed";

-- Drop actor_rate_control.next_allowed_at (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "actor_rate_control" DROP COLUMN IF EXISTS "next_allowed_at";

-- Drop actor_rate_control.last_successful_run (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: 2025-11-13 06:44:44.173133
ALTER TABLE "actor_rate_control" DROP COLUMN IF EXISTS "last_successful_run";

-- Drop actors.traffic_weight (DELETE_CONSTANT: 71 rows, 1 distinct, last ref 5d ago)
-- Sample values: 100
ALTER TABLE "actors" DROP COLUMN IF EXISTS "traffic_weight";

-- Drop actors.last_performance_check (DELETE_EMPTY: 0 rows, 0 distinct, last ref 5d ago)
-- Sample values: 
ALTER TABLE "actors" DROP COLUMN IF EXISTS "last_performance_check";

-- Drop conversation_dialogue.reads_from_step_ids (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: (empty table)
ALTER TABLE "conversation_dialogue" DROP COLUMN IF EXISTS "reads_from_step_ids";

-- Drop conversation_runs.run_type (DELETE_CONSTANT: 102936 rows, 1 distinct)
-- Sample values: production
ALTER TABLE "conversation_runs" DROP COLUMN IF EXISTS "run_type";

-- Drop conversation_runs.dialogue_round (DELETE_CONSTANT: 102936 rows, 1 distinct)
-- Sample values: 1
...
-- Drop execution_events.event_version (DELETE_CONSTANT: 17616 rows, 1 distinct)
-- Sample values: 1
...
-- Drop interaction_lineage.influence_type (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "interaction_lineage" DROP COLUMN IF EXISTS "influence_type";

-- Drop interaction_lineage.placeholder_used (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "interaction_lineage" DROP COLUMN IF EXISTS "placeholder_used";

-- Drop job_sources.source_url (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: https://api-deutschebank.beesite.de/search/
ALTER TABLE "job_sources" DROP COLUMN IF EXISTS "source_url";

-- Drop job_sources.fetch_schedule (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: daily
ALTER TABLE "job_sources" DROP COLUMN IF EXISTS "fetch_schedule";

-- Drop job_sources.last_fetch_at (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: 2025-11-29 18:20:50.897477
ALTER TABLE "job_sources" DROP COLUMN IF EXISTS "last_fetch_at";

-- Drop job_sources.last_fetch_count (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: 50
ALTER TABLE "job_sources" DROP COLUMN IF EXISTS "last_fetch_count";

-- Drop job_sources.next_fetch_at (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "job_sources" DROP COLUMN IF EXISTS "next_fetch_at";

-- Drop job_sources.total_jobs_fetched (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: 366
ALTER TABLE "job_sources" DROP COLUMN IF EXISTS "total_jobs_fetched";

-- Drop job_sources.total_jobs_active (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: 0
ALTER TABLE "job_sources" DROP COLUMN IF EXISTS "total_jobs_active";

-- Drop llm_interactions.dialogue_step_run_id (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "llm_interactions" DROP COLUMN IF EXISTS "dialogue_step_run_id";

-- Drop organizations.organization_type (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "organizations" DROP COLUMN IF EXISTS "organization_type";

-- Drop organizations.contact_email (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "organizations" DROP COLUMN IF EXISTS "contact_email";

-- Drop organizations.contact_phone (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "organizations" DROP COLUMN IF EXISTS "contact_phone";

-- Drop organizations.website_url (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "organizations" DROP COLUMN IF EXISTS "website_url";

-- Drop placeholder_definitions.source_query (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "placeholder_definitions" DROP COLUMN IF EXISTS "source_query";

-- Drop placeholder_definitions.default_value (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "placeholder_definitions" DROP COLUMN IF EXISTS "default_value";

-- Drop posting_fetch_runs.fetch_metadata (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "posting_fetch_runs" DROP COLUMN IF EXISTS "fetch_metadata";

-- Drop posting_field_mappings.source_field_name (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "posting_field_mappings" DROP COLUMN IF EXISTS "source_field_name";

-- Drop posting_field_mappings.target_field_name (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "posting_field_mappings" DROP COLUMN IF EXISTS "target_field_name";

-- Drop posting_field_mappings.transformation_rule (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "posting_field_mappings" DROP COLUMN IF EXISTS "transformation_rule";

-- Drop posting_processing_status.summary_extracted (DELETE_CONSTANT: 50 rows, 1 distinct, last ref 11d ago)
-- Sample values: f
ALTER TABLE "posting_processing_status" DROP COLUMN IF EXISTS "summary_extracted";

-- Drop posting_processing_status.summary_workflow_run_id (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "posting_processing_status" DROP COLUMN IF EXISTS "summary_workflow_run_id";

-- Drop posting_processing_status.skills_extracted_at (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "posting_processing_status" DROP COLUMN IF EXISTS "skills_extracted_at";

-- Drop posting_processing_status.skills_workflow_run_id (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "posting_processing_status" DROP COLUMN IF EXISTS "skills_workflow_run_id";

-- Drop posting_processing_status.ihl_analyzed (DELETE_CONSTANT: 50 rows, 1 distinct, last ref 0d ago)
-- Sample values: f
ALTER TABLE "posting_processing_status" DROP COLUMN IF EXISTS "ihl_analyzed";

-- Drop posting_processing_status.candidates_matched (DELETE_CONSTANT: 50 rows, 1 distinct)
-- Sample values: f
ALTER TABLE "posting_processing_status" DROP COLUMN IF EXISTS "candidates_matched";

-- Drop posting_processing_status.candidates_matched_at (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "posting_processing_status" DROP COLUMN IF EXISTS "candidates_matched_at";

-- Drop posting_processing_status.matching_workflow_run_id (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "posting_processing_status" DROP COLUMN IF EXISTS "matching_workflow_run_id";

-- Drop posting_processing_status.processing_complete (DELETE_CONSTANT: 50 rows, 1 distinct)
-- Sample values: f
ALTER TABLE "posting_processing_status" DROP COLUMN IF EXISTS "processing_complete";

-- Drop posting_processing_status.last_processed_at (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "posting_processing_status" DROP COLUMN IF EXISTS "last_processed_at";

-- Drop posting_sources.scraper_config (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: {"pagination": true, "max_results": 100, "api_endpoint": "/api/job-req-service/jobReqSearch"}
ALTER TABLE "posting_sources" DROP COLUMN IF EXISTS "scraper_config";

-- Drop posting_sources.last_scraped_at (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: 2025-10-31 09:46:30.754033
ALTER TABLE "posting_sources" DROP COLUMN IF EXISTS "last_scraped_at";

-- Drop posting_state_projection.conversation_history (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "posting_state_projection" DROP COLUMN IF EXISTS "conversation_history";

-- Drop posting_state_projection.total_duration_ms (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "posting_state_projection" DROP COLUMN IF EXISTS "total_duration_ms";

-- Drop posting_state_projection.last_event_id (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "posting_state_projection" DROP COLUMN IF EXISTS "last_event_id";

-- Drop posting_state_projection.projection_version (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
...
-- Drop profile_certifications.credential_id (DELETE_EMPTY: 0 rows, 0 distinct, last ref 31d ago)
-- Sample values: 
ALTER TABLE "profile_certifications" DROP COLUMN IF EXISTS "credential_id";

-- Drop profile_certifications.credential_url (DELETE_EMPTY: 0 rows, 0 distinct, last ref 31d ago)
-- Sample values: 
ALTER TABLE "profile_certifications" DROP COLUMN IF EXISTS "credential_url";

-- Drop profile_certifications.does_not_expire (DELETE_CONSTANT: 12 rows, 1 distinct, last ref 31d ago)
-- Sample values: f
ALTER TABLE "profile_certifications" DROP COLUMN IF EXISTS "does_not_expire";

-- Drop profile_education.institution_name (DELETE_SPARSE: 3 rows, 3 distinct, last ref 31d ago)
-- Sample values: University of California, Berkeley, University of Southern California, University of Washington
ALTER TABLE "profile_education" DROP COLUMN IF EXISTS "institution_name";

-- Drop profile_education.institution_location (DELETE_EMPTY: 0 rows, 0 distinct, last ref 31d ago)
-- Sample values: 
ALTER TABLE "profile_education" DROP COLUMN IF EXISTS "institution_location";

-- Drop profile_education.degree_type (DELETE_SPARSE: 3 rows, 2 distinct, last ref 31d ago)
-- Sample values: Bachelor of Arts, Bachelor of Science
ALTER TABLE "profile_education" DROP COLUMN IF EXISTS "degree_type";

-- Drop profile_education.degree_name (DELETE_EMPTY: 0 rows, 0 distinct, last ref 31d ago)
-- Sample values: 
ALTER TABLE "profile_education" DROP COLUMN IF EXISTS "degree_name";

-- Drop profile_education.graduation_year (DELETE_SPARSE: 3 rows, 3 distinct, last ref 31d ago)
-- Sample values: 2012, 2014, 2016
ALTER TABLE "profile_education" DROP COLUMN IF EXISTS "graduation_year";

-- Drop profile_education.gpa (DELETE_EMPTY: 0 rows, 0 distinct, last ref 0d ago)
-- Sample values: 
ALTER TABLE "profile_education" DROP COLUMN IF EXISTS "gpa";

-- Drop profile_education.honors (DELETE_EMPTY: 0 rows, 0 distinct, last ref 31d ago)
-- Sample values: 
ALTER TABLE "profile_education" DROP COLUMN IF EXISTS "honors";

-- Drop profile_education.thesis_title (DELETE_EMPTY: 0 rows, 0 distinct, last ref 31d ago)
-- Sample values: 
ALTER TABLE "profile_education" DROP COLUMN IF EXISTS "thesis_title";

-- Drop profile_education.relevant_coursework (DELETE_EMPTY: 0 rows, 0 distinct, last ref 31d ago)
-- Sample values: 
ALTER TABLE "profile_education" DROP COLUMN IF EXISTS "relevant_coursework";

-- Drop profile_job_matches.overall_match_score (DELETE_EMPTY: 0 rows, 0 distinct, last ref 31d ago)
-- Sample values: 
ALTER TABLE "profile_job_matches" DROP COLUMN IF EXISTS "overall_match_score";

-- Drop profile_job_matches.skill_match_score (DELETE_EMPTY: 0 rows, 0 distinct, last ref 12d ago)
-- Sample values: 
ALTER TABLE "profile_job_matches" DROP COLUMN IF EXISTS "skill_match_score";

-- Drop profile_job_matches.experience_match_score (DELETE_EMPTY: 0 rows, 0 distinct, last ref 31d ago)
-- Sample values: 
ALTER TABLE "profile_job_matches" DROP COLUMN IF EXISTS "experience_match_score";

-- Drop profile_job_matches.location_match_score (DELETE_EMPTY: 0 rows, 0 distinct, last ref 31d ago)
-- Sample values: 
ALTER TABLE "profile_job_matches" DROP COLUMN IF EXISTS "location_match_score";

-- Drop profile_job_matches.extra_skills (DELETE_EMPTY: 0 rows, 0 distinct, last ref 31d ago)
-- Sample values: 
ALTER TABLE "profile_job_matches" DROP COLUMN IF EXISTS "extra_skills";

-- Drop profile_job_matches.match_quality (DELETE_EMPTY: 0 rows, 0 distinct, last ref 31d ago)
-- Sample values: 
ALTER TABLE "profile_job_matches" DROP COLUMN IF EXISTS "match_quality";

-- Drop profile_job_matches.match_explanation (DELETE_EMPTY: 0 rows, 0 distinct, last ref 31d ago)
-- Sample values: 
ALTER TABLE "profile_job_matches" DROP COLUMN IF EXISTS "match_explanation";

-- Drop profile_job_matches.matched_at (DELETE_EMPTY: 0 rows, 0 distinct, last ref 31d ago)
-- Sample values: 
ALTER TABLE "profile_job_matches" DROP COLUMN IF EXISTS "matched_at";

-- Drop profile_job_matches.contacted_at (DELETE_EMPTY: 0 rows, 0 distinct, last ref 31d ago)
-- Sample values: 
ALTER TABLE "profile_job_matches" DROP COLUMN IF EXISTS "contacted_at";

-- Drop profile_job_matches.recruiter_notes (DELETE_EMPTY: 0 rows, 0 distinct, last ref 31d ago)
-- Sample values: 
ALTER TABLE "profile_job_matches" DROP COLUMN IF EXISTS "recruiter_notes";

-- Drop profile_languages.speaking_level (DELETE_EMPTY: 0 rows, 0 distinct, last ref 31d ago)
-- Sample values: 
ALTER TABLE "profile_languages" DROP COLUMN IF EXISTS "speaking_level";

-- Drop profile_languages.writing_level (DELETE_EMPTY: 0 rows, 0 distinct, last ref 31d ago)
-- Sample values: 
ALTER TABLE "profile_languages" DROP COLUMN IF EXISTS "writing_level";

-- Drop profile_languages.reading_level (DELETE_EMPTY: 0 rows, 0 distinct, last ref 31d ago)
-- Sample values: 
ALTER TABLE "profile_languages" DROP COLUMN IF EXISTS "reading_level";

-- Drop profile_skills.last_used_date (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "profile_skills" DROP COLUMN IF EXISTS "last_used_date";

-- Drop profiles.availability_status (DELETE_SPARSE: 4 rows, 2 distinct, last ref 31d ago)
-- Sample values: active, passive
ALTER TABLE "profiles" DROP COLUMN IF EXISTS "availability_status";

-- Drop profiles.currency (DELETE_CONSTANT: 4 rows, 1 distinct, last ref 11d ago)
-- Sample values: CHF
ALTER TABLE "profiles" DROP COLUMN IF EXISTS "currency";

-- Drop profiles.desired_locations (DELETE_EMPTY: 0 rows, 0 distinct, last ref 31d ago)
-- Sample values: 
ALTER TABLE "profiles" DROP COLUMN IF EXISTS "desired_locations";

-- Drop profiles.desired_roles (DELETE_EMPTY: 0 rows, 0 distinct, last ref 31d ago)
-- Sample values: 
ALTER TABLE "profiles" DROP COLUMN IF EXISTS "desired_roles";

-- Drop profiles.expected_salary_max (DELETE_EMPTY: 0 rows, 0 distinct, last ref 31d ago)
-- Sample values: 
ALTER TABLE "profiles" DROP COLUMN IF EXISTS "expected_salary_max";

-- Drop profiles.expected_salary_min (DELETE_EMPTY: 0 rows, 0 distinct, last ref 31d ago)
-- Sample values: 
ALTER TABLE "profiles" DROP COLUMN IF EXISTS "expected_salary_min";

-- Drop profiles.is_test_profile (DELETE_CONSTANT: 4 rows, 1 distinct)
-- Sample values: t
ALTER TABLE "profiles" DROP COLUMN IF EXISTS "is_test_profile";

-- Drop profiles.last_activity_date (DELETE_EMPTY: 0 rows, 0 distinct, last ref 31d ago)
-- Sample values: 
ALTER TABLE "profiles" DROP COLUMN IF EXISTS "last_activity_date";

-- Drop profiles.profile_raw_text (DELETE_SPARSE: 4 rows, 4 distinct, last ref 31d ago)
-- Sample values: +
ALTER TABLE "profiles" DROP COLUMN IF EXISTS "profile_raw_text";

-- Drop profiles.profile_source (DELETE_CONSTANT: 1 rows, 1 distinct, last ref 31d ago)
-- Sample values: markdown
ALTER TABLE "profiles" DROP COLUMN IF EXISTS "profile_source";

-- Drop profiles.profile_type (DELETE_CONSTANT: 4 rows, 1 distinct)
-- Sample values: self
ALTER TABLE "profiles" DROP COLUMN IF EXISTS "profile_type";

-- Drop profiles.search_vector (DELETE_SPARSE: 4 rows, 4 distinct, last ref 31d ago)
...
-- Drop profiles.skills_extraction_status (DELETE_CONSTANT: 4 rows, 1 distinct, last ref 31d ago)
-- Sample values: success
ALTER TABLE "profiles" DROP COLUMN IF EXISTS "skills_extraction_status";

-- Drop script_executions.executed_by (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "script_executions" DROP COLUMN IF EXISTS "executed_by";

-- Drop script_executions.execution_args (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "script_executions" DROP COLUMN IF EXISTS "execution_args";

-- Drop script_executions.execution_context (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "script_executions" DROP COLUMN IF EXISTS "execution_context";

-- Drop script_executions.return_value (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "script_executions" DROP COLUMN IF EXISTS "return_value";

-- Drop script_executions.stdout_log (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "script_executions" DROP COLUMN IF EXISTS "stdout_log";

-- Drop script_executions.stderr_log (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "script_executions" DROP COLUMN IF EXISTS "stderr_log";
...
-- Drop stored_scripts.script_name (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: turing_job_fetcher
ALTER TABLE "stored_scripts" DROP COLUMN IF EXISTS "script_name";

-- Drop stored_scripts.script_description (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: Turing-integrated job fetcher. Fetches from Deutsche Bank API, stores in database with deduplication.
ALTER TABLE "stored_scripts" DROP COLUMN IF EXISTS "script_description";

-- Drop stored_scripts.script_category (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: job_ingestion
ALTER TABLE "stored_scripts" DROP COLUMN IF EXISTS "script_category";

-- Drop stored_scripts.requires_packages (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: psycopg2, requests, beautifulsoup4
ALTER TABLE "stored_scripts" DROP COLUMN IF EXISTS "requires_packages";

-- Drop stored_scripts.requires_scripts (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "stored_scripts" DROP COLUMN IF EXISTS "requires_scripts";

-- Drop stored_scripts.entry_point (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: TuringJobFetcher.fetch_jobs_for_user
ALTER TABLE "stored_scripts" DROP COLUMN IF EXISTS "entry_point";

-- Drop stored_scripts.expected_args (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: user_id, max_jobs
ALTER TABLE "stored_scripts" DROP COLUMN IF EXISTS "expected_args";

-- Drop stored_scripts.returns_data_type (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: Dict[str, int]
ALTER TABLE "stored_scripts" DROP COLUMN IF EXISTS "returns_data_type";

-- Drop stored_scripts.is_current_version (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: t
ALTER TABLE "stored_scripts" DROP COLUMN IF EXISTS "is_current_version";

-- Drop stored_scripts.usage_example (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: from turing_job_fetcher import TuringJobFetcher            +
ALTER TABLE "stored_scripts" DROP COLUMN IF EXISTS "usage_example";

-- Drop stored_scripts.change_log (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: Initial version: Complete Turing integration, user preferences support, lifecycle tracking
ALTER TABLE "stored_scripts" DROP COLUMN IF EXISTS "change_log";

-- Drop stored_scripts.is_production (DELETE_CONSTANT: 1 rows, 1 distinct, last ref 5d ago)
-- Sample values: t
ALTER TABLE "stored_scripts" DROP COLUMN IF EXISTS "is_production";

-- Drop stored_scripts.last_executed_at (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "stored_scripts" DROP COLUMN IF EXISTS "last_executed_at";

-- Drop stored_scripts.execution_count (DELETE_CONSTANT: 1 rows, 1 distinct, last ref 5d ago)
-- Sample values: 0
ALTER TABLE "stored_scripts" DROP COLUMN IF EXISTS "execution_count";

-- Drop test_cases.test_case_name (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: profile_1_career_analysis
ALTER TABLE "test_cases" DROP COLUMN IF EXISTS "test_case_name";

-- Drop user_posting_decisions.cover_letter_draft (DELETE_EMPTY: 0 rows, 0 distinct, last ref 23d ago)
-- Sample values: 
ALTER TABLE "user_posting_decisions" DROP COLUMN IF EXISTS "cover_letter_draft";

-- Drop user_posting_decisions.no_go_reason (DELETE_EMPTY: 0 rows, 0 distinct, last ref 23d ago)
-- Sample values: 
ALTER TABLE "user_posting_decisions" DROP COLUMN IF EXISTS "no_go_reason";

-- Drop user_posting_decisions.decision_generated_at (DELETE_EMPTY: 0 rows, 0 distinct, last ref 23d ago)
-- Sample values: 
...
-- Drop user_posting_preferences.preference_type (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "user_posting_preferences" DROP COLUMN IF EXISTS "preference_type";

-- Drop user_posting_preferences.preference_value (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "user_posting_preferences" DROP COLUMN IF EXISTS "preference_value";

-- Drop user_preferences.preferred_divisions (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "user_preferences" DROP COLUMN IF EXISTS "preferred_divisions";

-- Drop user_preferences.preferred_companies (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "user_preferences" DROP COLUMN IF EXISTS "preferred_companies";

-- Drop user_preferences.min_salary (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "user_preferences" DROP COLUMN IF EXISTS "min_salary";

-- Drop user_preferences.max_salary (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "user_preferences" DROP COLUMN IF EXISTS "max_salary";

-- Drop user_preferences.currency (DELETE_CONSTANT: 1 rows, 1 distinct, last ref 11d ago)
-- Sample values: EUR
ALTER TABLE "user_preferences" DROP COLUMN IF EXISTS "currency";

-- Drop user_preferences.remote_only (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: f
ALTER TABLE "user_preferences" DROP COLUMN IF EXISTS "remote_only";

-- Drop user_preferences.willing_to_relocate (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: t
ALTER TABLE "user_preferences" DROP COLUMN IF EXISTS "willing_to_relocate";

-- Drop user_preferences.preferred_skills (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "user_preferences" DROP COLUMN IF EXISTS "preferred_skills";

-- Drop user_preferences.employment_types (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "user_preferences" DROP COLUMN IF EXISTS "employment_types";

-- Drop user_preferences.max_travel_percentage (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "user_preferences" DROP COLUMN IF EXISTS "max_travel_percentage";

-- Drop user_preferences.alert_on_new_jobs (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: t
ALTER TABLE "user_preferences" DROP COLUMN IF EXISTS "alert_on_new_jobs";

-- Drop user_preferences.alert_on_matches (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: t
ALTER TABLE "user_preferences" DROP COLUMN IF EXISTS "alert_on_matches";

-- Drop user_preferences.alert_frequency (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: daily
ALTER TABLE "user_preferences" DROP COLUMN IF EXISTS "alert_frequency";

-- Drop user_saved_postings.saved_at (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "user_saved_postings" DROP COLUMN IF EXISTS "saved_at";

-- Drop user_saved_postings.application_status (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "user_saved_postings" DROP COLUMN IF EXISTS "application_status";

-- Drop user_saved_postings.application_date (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "user_saved_postings" DROP COLUMN IF EXISTS "application_date";

-- Drop users.password_hash (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: $2b$12$demo.hash.placeholder
ALTER TABLE "users" DROP COLUMN IF EXISTS "password_hash";

-- Drop users.is_job_seeker (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: t
ALTER TABLE "users" DROP COLUMN IF EXISTS "is_job_seeker";

-- Drop users.is_recruiter (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: f
ALTER TABLE "users" DROP COLUMN IF EXISTS "is_recruiter";

-- Drop users.is_admin (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: t
ALTER TABLE "users" DROP COLUMN IF EXISTS "is_admin";

-- Drop users.last_login_at (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "users" DROP COLUMN IF EXISTS "last_login_at";

-- Drop users.email_verified_at (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: 2025-10-31 09:46:30.750825
ALTER TABLE "users" DROP COLUMN IF EXISTS "email_verified_at";

-- Drop workflow_conversations.parallel_group (DELETE_CONSTANT: 2 rows, 1 distinct, last ref 26d ago)
-- Sample values: 1
ALTER TABLE "workflow_conversations" DROP COLUMN IF EXISTS "parallel_group";

-- Drop workflow_dependencies.dependency_type (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "workflow_dependencies" DROP COLUMN IF EXISTS "dependency_type";

-- Drop workflow_dependencies.pass_output_as_input (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "workflow_dependencies" DROP COLUMN IF EXISTS "pass_output_as_input";

-- Drop workflow_dependencies.output_mapping (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "workflow_dependencies" DROP COLUMN IF EXISTS "output_mapping";

-- Drop workflow_doc_queue.last_changed_at (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: 2025-11-27 09:05:07.267828
ALTER TABLE "workflow_doc_queue" DROP COLUMN IF EXISTS "last_changed_at";

-- Drop workflow_doc_queue.last_generated_at (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "workflow_doc_queue" DROP COLUMN IF EXISTS "last_generated_at";

-- Drop workflow_errors.actor_output (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "workflow_errors" DROP COLUMN IF EXISTS "actor_output";

-- Drop workflow_errors.resolved_at (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "workflow_errors" DROP COLUMN IF EXISTS "resolved_at";

-- Drop workflow_metrics.metric_name (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "workflow_metrics" DROP COLUMN IF EXISTS "metric_name";

-- Drop workflow_metrics.metric_unit (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "workflow_metrics" DROP COLUMN IF EXISTS "metric_unit";

-- Drop workflow_triggers.schedule_cron (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: 0 8 * * *
ALTER TABLE "workflow_triggers" DROP COLUMN IF EXISTS "schedule_cron";

-- Drop workflow_triggers.schedule_timezone (DELETE_CONSTANT: 3 rows, 1 distinct)
-- Sample values: Europe/Berlin
ALTER TABLE "workflow_triggers" DROP COLUMN IF EXISTS "schedule_timezone";

-- Drop workflow_triggers.event_check_interval_minutes (DELETE_SPARSE: 3 rows, 2 distinct)
-- Sample values: 5, 30
ALTER TABLE "workflow_triggers" DROP COLUMN IF EXISTS "event_check_interval_minutes";

-- Drop workflow_triggers.max_concurrent_runs (DELETE_SPARSE: 3 rows, 2 distinct)
-- Sample values: 1, 5
ALTER TABLE "workflow_triggers" DROP COLUMN IF EXISTS "max_concurrent_runs";

-- Drop workflow_triggers.timeout_minutes (DELETE_CONSTANT: 3 rows, 1 distinct)
-- Sample values: 60
ALTER TABLE "workflow_triggers" DROP COLUMN IF EXISTS "timeout_minutes";

-- Drop workflow_triggers.depends_on_trigger_ids (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "workflow_triggers" DROP COLUMN IF EXISTS "depends_on_trigger_ids";

-- Drop workflow_triggers.run_after_workflow_ids (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "workflow_triggers" DROP COLUMN IF EXISTS "run_after_workflow_ids";

-- Drop workflow_triggers.min_interval_minutes (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "workflow_triggers" DROP COLUMN IF EXISTS "min_interval_minutes";

-- Drop workflow_triggers.max_runs_per_day (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "workflow_triggers" DROP COLUMN IF EXISTS "max_runs_per_day";

-- Drop workflow_triggers.max_runs_per_hour (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "workflow_triggers" DROP COLUMN IF EXISTS "max_runs_per_hour";

-- Drop workflow_triggers.default_parameters (DELETE_CONSTANT: 1 rows, 1 distinct)
-- Sample values: {"document_text": null}
ALTER TABLE "workflow_triggers" DROP COLUMN IF EXISTS "default_parameters";

-- Drop workflow_triggers.last_triggered_at (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "workflow_triggers" DROP COLUMN IF EXISTS "last_triggered_at";

-- Drop workflow_triggers.next_scheduled_run (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "workflow_triggers" DROP COLUMN IF EXISTS "next_scheduled_run";

-- Drop workflow_triggers.successful_runs (DELETE_CONSTANT: 3 rows, 1 distinct, last ref 40d ago)
-- Sample values: 0
ALTER TABLE "workflow_triggers" DROP COLUMN IF EXISTS "successful_runs";

-- Drop workflow_triggers.failed_runs (DELETE_CONSTANT: 3 rows, 1 distinct, last ref 40d ago)
-- Sample values: 0
ALTER TABLE "workflow_triggers" DROP COLUMN IF EXISTS "failed_runs";

-- Drop workflow_variables.default_value (DELETE_EMPTY: 0 rows, 0 distinct)
-- Sample values: 
ALTER TABLE "workflow_variables" DROP COLUMN IF EXISTS "default_value";

-- Drop workflow_variables.example_value (DELETE_SPARSE: 3 rows, 3 distinct)
-- Sample values: "68147", "Risk Analyst", ["https://db.wd3.myworkdayjobs.com/DBWebsite/job/Mumbai-Nirlon-Knowledge-Pk-B1/Risk-Analyst_R0405266/apply"]
ALTER TABLE "workflow_variables" DROP COLUMN IF EXISTS "example_value";

-- Drop workflows.workflow_version (DELETE_CONSTANT: 5 rows, 1 distinct, last ref 11d ago)
-- Sample values: 1
ALTER TABLE "workflows" DROP COLUMN IF EXISTS "workflow_version";

-- Drop workflows.app_scope (DELETE_CONSTANT: 5 rows, 1 distinct)
-- Sample values: talent
ALTER TABLE "workflows" DROP COLUMN IF EXISTS "app_scope";

-- Drop workflows.skip_data_writes (DELETE_CONSTANT: 5 rows, 1 distinct, last ref 5d ago)
-- Sample values: f
ALTER TABLE "workflows" DROP COLUMN IF EXISTS "skip_data_writes";

-- Drop workflows_history.workflow_version (DELETE_CONSTANT: 1535 rows, 1 distinct, last ref 11d ago)
-- Sample values: 1
ALTER TABLE "workflows_history" DROP COLUMN IF EXISTS "workflow_version";
...
-- Verify actor_rate_control
SELECT column_name FROM information_schema.columns WHERE table_name = 'actor_rate_control' AND table_schema = 'public' ORDER BY ordinal_position;

-- Verify actors
SELECT column_name FROM information_schema.columns WHERE table_name = 'actors' AND table_schema = 'public' ORDER BY ordinal_position;

-- Verify conversation_dialogue
SELECT column_name FROM information_schema.columns WHERE table_name = 'conversation_dialogue' AND table_schema = 'public' ORDER BY ordinal_position;

-- Verify conversation_runs
SELECT column_name FROM information_schema.columns WHERE table_name = 'conversation_runs' AND table_schema = 'public' ORDER BY ordinal_position;
...
-- Verify execution_events
SELECT column_name FROM information_schema.columns WHERE table_name = 'execution_events' AND table_schema = 'public' ORDER BY ordinal_position;
...
-- Verify interaction_lineage
SELECT column_name FROM information_schema.columns WHERE table_name = 'interaction_lineage' AND table_schema = 'public' ORDER BY ordinal_position;

-- Verify job_sources
SELECT column_name FROM information_schema.columns WHERE table_name = 'job_sources' AND table_schema = 'public' ORDER BY ordinal_position;

-- Verify llm_interactions
SELECT column_name FROM information_schema.columns WHERE table_name = 'llm_interactions' AND table_schema = 'public' ORDER BY ordinal_position;

-- Verify organizations
SELECT column_name FROM information_schema.columns WHERE table_name = 'organizations' AND table_schema = 'public' ORDER BY ordinal_position;

-- Verify placeholder_definitions
SELECT column_name FROM information_schema.columns WHERE table_name = 'placeholder_definitions' AND table_schema = 'public' ORDER BY ordinal_position;

-- Verify posting_fetch_runs
SELECT column_name FROM information_schema.columns WHERE table_name = 'posting_fetch_runs' AND table_schema = 'public' ORDER BY ordinal_position;

-- Verify posting_field_mappings
SELECT column_name FROM information_schema.columns WHERE table_name = 'posting_field_mappings' AND table_schema = 'public' ORDER BY ordinal_position;

-- Verify posting_processing_status
SELECT column_name FROM information_schema.columns WHERE table_name = 'posting_processing_status' AND table_schema = 'public' ORDER BY ordinal_position;

-- Verify posting_sources
SELECT column_name FROM information_schema.columns WHERE table_name = 'posting_sources' AND table_schema = 'public' ORDER BY ordinal_position;

-- Verify posting_state_projection
SELECT column_name FROM information_schema.columns WHERE table_name = 'posting_state_projection' AND table_schema = 'public' ORDER BY ordinal_position;
...
-- Verify profile_skills
SELECT column_name FROM information_schema.columns WHERE table_name = 'profile_skills' AND table_schema = 'public' ORDER BY ordinal_position;
...
-- Verify script_executions
SELECT column_name FROM information_schema.columns WHERE table_name = 'script_executions' AND table_schema = 'public' ORDER BY ordinal_position;
...
-- Verify stored_scripts
SELECT column_name FROM information_schema.columns WHERE table_name = 'stored_scripts' AND table_schema = 'public' ORDER BY ordinal_position;

-- Verify test_cases
SELECT column_name FROM information_schema.columns WHERE table_name = 'test_cases' AND table_schema = 'public' ORDER BY ordinal_position;
...
-- Verify user_posting_preferences
SELECT column_name FROM information_schema.columns WHERE table_name = 'user_posting_preferences' AND table_schema = 'public' ORDER BY ordinal_position;

-- Verify user_preferences
SELECT column_name FROM information_schema.columns WHERE table_name = 'user_preferences' AND table_schema = 'public' ORDER BY ordinal_position;

-- Verify user_saved_postings
SELECT column_name FROM information_schema.columns WHERE table_name = 'user_saved_postings' AND table_schema = 'public' ORDER BY ordinal_position;
...
-- Verify workflow_conversations
SELECT column_name FROM information_schema.columns WHERE table_name = 'workflow_conversations' AND table_schema = 'public' ORDER BY ordinal_position;

-- Verify workflow_dependencies
SELECT column_name FROM information_schema.columns WHERE table_name = 'workflow_dependencies' AND table_schema = 'public' ORDER BY ordinal_position;

-- Verify workflow_doc_queue
SELECT column_name FROM information_schema.columns WHERE table_name = 'workflow_doc_queue' AND table_schema = 'public' ORDER BY ordinal_position;

-- Verify workflow_errors
SELECT column_name FROM information_schema.columns WHERE table_name = 'workflow_errors' AND table_schema = 'public' ORDER BY ordinal_position;

-- Verify workflow_metrics
SELECT column_name FROM information_schema.columns WHERE table_name = 'workflow_metrics' AND table_schema = 'public' ORDER BY ordinal_position;

-- Verify workflow_triggers
SELECT column_name FROM information_schema.columns WHERE table_name = 'workflow_triggers' AND table_schema = 'public' ORDER BY ordinal_position;

-- Verify workflow_variables
SELECT column_name FROM information_schema.columns WHERE table_name = 'workflow_variables' AND table_schema = 'public' ORDER BY ordinal_position;
...
-- Verify workflows_history
SELECT column_name FROM information_schema.columns WHERE table_name = 'workflows_history' AND table_schema = 'public' ORDER BY ordinal_position;
