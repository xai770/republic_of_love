...
if __name__ == "__main__" or not __package__:
    ...
    from config_manager import ConfigManager, ConfigSnapshot, ConfigError  # type: ignore[import]
else:
    # Module import - use relative imports  
    from .config_manager import ConfigManager, ConfigSnapshot, ConfigError  # type: ignore[no-redef]
