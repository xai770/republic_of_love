...
A **skill taxonomy system** that organizes thousands of professional skills into a hierarchical folder structure. Think of it like organizing files into folders - "kubernetes" goes into `technical → containerization`, "leadership" goes into `interpersonal`, etc.

**The Pipeline:**
```
WF2003 (Dual-Grader Classify) → WF2004 (QA/Split) → WF2005 (Wire Orphans)
```
...
- WF2003 processed all 200 → 172 grouped across 9 root categories
- Queued all roots for WF2004 (including oversized ones)

**Root category distribution after WF2003:**
```
technical: 63 skills ← needs splitting!
interpersonal: 34
domain_expertise: 31
