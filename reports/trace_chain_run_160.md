...
**Started:** 2025-11-25 20:34:05
**Completed:** 2025-11-25 20:35:15
...
{
  "data": {
    "error": "syntax error at or near \"{\"\nLINE 1: ...exists FROM workflow_runs WHERE workflow_run_id = {workflow_...\n                                                             ^\n",
    "status": "[RUN]"
  },
  "status": "success"
}
...
````
Here’s the concise job description summary based solely on the provided text:
...
**Key Responsibilities:**
- Analyze and report on DB Group capital adequacy, focusing on mutual information between Pillar 1 (regulatory models) and Pillar 2 capital metrics.
- Manage the economic capital model for earnings volatility risk under stress.
- Support framework enhancements related to non-standard risks (e.g., step-in risk, insurance risk).
- Participate in projects related to capital adequacy topics and ICAAP forums.
- Monitor and drive regulatory changes impacting the team’s book of work.
- Support implementation of supervisor and auditor measures.

**Requirements:**
- Good knowledge of risk management frameworks & capital adequacy regulations.
...
**Metadata:** `{"model": "gemma3:1b", "latency_ms": 4413}`
...
The summary accurately reflects the information presented in the original job posting. It captures the key responsibilities and requirements without introducing any fabricated details. The formatting also adheres to the provided template.  


Here are some specific points that demonstrate the accuracy of the summary:

* **Responsibilities:** The summary correctly lists the primary tasks outlined in the job description, such as analyzing capital adequacy, managing economic capital models, and supporting framework enhancements. 
* **Requirements:** The summary accurately reflects the skills and qualifications Deutsche Bank seeks in a CA Intern, including knowledge of risk management frameworks, project management abilities, and strong analytical and communication skills.
* **Formatting:**  The summary uses clear headings and bullet points to organize the information effectively, aligning with the requested format. 



Overall, the AI-generated summary is a concise and faithful representation of the original job posting.
````

**Metadata:** `{"model": "gemma2:latest", "latency_ms": 25652}`
...
The summary accurately captures the key details from the original job posting without any hallucinated details. It includes the role, company, location, and job responsibilities and requirements as outlined in the posting. The formatting follows the requested ===OUTPUT TEMPLATE=== format correctly. Therefore, it is a well-formatted, accurate, and complete summary.
````

**Metadata:** `{"model": "qwen2.5:7b", "latency_ms": 5444}`
...
**Metadata:** `{"model": "gemma2:latest", "latency_ms": 29590}`
...
{
  "data": {
    "error": "syntax error at or near \"{\"\nLINE 1: ...ecuted FROM workflow_runs WHERE workflow_run_id = {workflow_...\n                                                             ^\n",
    "status": "[RUN]"
  },
  "status": "success"
}
