...
**Started:** 2025-11-25 12:43:54
**Completed:** 2025-11-25 12:44:28
...
**Metadata:** `{"model": "gemma3:1b", "latency_ms": 5478}`
...
* **Accuracy:** There are no hallucinations or inaccuracies in the summary. All the details provided align with the original posting.
* **Completeness:** The key responsibilities and requirements mentioned in the job description are all included in the summary.  
* **Formatting:** The summary follows the requested ===OUTPUT TEMPLATE=== format, making it easy to read and understand. 


Overall, the AI has done a good job summarizing the job posting.
```

**Metadata:** `{"model": "gemma2:latest", "latency_ms": 19900}`
...
The summary accurately captures the key elements of the original job posting without any hallucinated details:

- The role (CA Intern), company (Deutsche Bank Group), and location (Mumbai, India) are correctly stated.
- Key responsibilities such as analyzing capital adequacy, managing economic capital models, participating in projects related to capital adequacy topics, monitoring regulatory changes, and supporting implementation of measures required by supervisors and auditors are all included.
- Requirements like good knowledge of risk management frameworks, strong project management skills, proficiency with MS Office tools, soft skills for communication, analytical and problem-solving abilities, organizational skills, passion for change, diligence, and proactivity as a team player are accurately described.

The summary format also closely follows the provided template. Therefore, it is accurate, complete, and well-formatted.
```

**Metadata:** `{"model": "qwen2.5:7b", "latency_ms": 8737}`
