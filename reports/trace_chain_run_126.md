...
**Started:** 2025-11-25 12:48:28
**Completed:** 2025-11-25 12:49:09
**Duration:** 40.8 seconds
**Interactions:** 3 completed, 0 failed
...
**Metadata:** `{"model": "gemma3:1b", "latency_ms": 5538}`
...
* **Accuracy:** There are no factual errors or hallucinations. The summary correctly captures the job title, company, location, key responsibilities, and requirements. 
* **Completeness:** The summary includes all the essential information from the posting. It covers both hard skills (e.g., knowledge of ICAAP) and soft skills (e.g., communication, problem-solving).
* **Formatting:** The summary adheres to the provided ===OUTPUT TEMPLATE=== format, making it easy to read and understand. 


Overall, the AI has done a good job summarizing the job posting in a clear, concise, and accurate manner.
````

**Metadata:** `{"model": "gemma2:latest", "latency_ms": 26492}`
...
- The location (Mumbai, India) and duration (12 Months) are correctly mentioned but not included in the template.
- Key responsibilities such as analyzing capital adequacy, managing economic capital models, participating in projects, and supporting regulatory changes are all covered.
- Requirements like good knowledge of risk management frameworks, strong project management skills, proficiency with MS Office, soft skills, and eligibility for Industrial Training are accurately listed.

The summary follows the provided ===OUTPUT TEMPLATE=== format, making it well-structured and easy to read. Overall, the summary is accurate, complete, and well-formatted.
````

**Metadata:** `{"model": "qwen2.5:7b", "latency_ms": 8648}`
...
- **Completed:** 3
- **Failed:** 0
- **Total duration:** 40.8s
- **Avg per interaction:** 13.59s
