...
**Started:** 2025-11-25 15:03:16
**Completed:** 2025-11-25 15:03:45
...
**Metadata:** `{"model": "gemma3:1b", "latency_ms": 4542}`
...
* **Accuracy:** There are no hallucinations or inaccuracies in the summarized information. 
* **Completeness:**  All key responsibilities and requirements mentioned in the posting are included in the summary.
* **Formatting:** The summary adheres to the provided ===OUTPUT TEMPLATE=== format, making it clear and organized.


The AI successfully condensed the job description into a concise and informative summary.
````

**Metadata:** `{"model": "gemma2:latest", "latency_ms": 18620}`
...
The summary accurately captures the key aspects of the job posting, including the role, company, location, and both key responsibilities and requirements. The formatting follows the ===OUTPUT TEMPLATE=== as specified. No errors, omissions, or hallucinations are present in the summary.
````

**Metadata:** `{"model": "qwen2.5:7b", "latency_ms": 5555}`
