...
**Started:** 2025-11-25 19:44:57
**Completed:** 2025-11-25 19:46:26
...
- Eligibility for Industrial Training as per the ICAI rules and regulations.
```
````

**Metadata:** `{"model": "gemma3:1b", "latency_ms": 5316}`
...
* **Accuracy:** There are no inaccuracies or hallucinated details in the summary.  All points mentioned align with the job description.
* **Completeness:** The summary captures the key responsibilities and requirements outlined in the posting. It includes details about managing capital adequacy, economic capital models, non-standard risk frameworks, regulatory changes, and project management skills. 
* **Formatting:** The summary follows a clear and consistent format using bullet points for responsibilities and requirements, making it easy to read and understand.


The summary effectively condenses the essential information from the job posting into a concise and informative format.
````

**Metadata:** `{"model": "gemma2:latest", "latency_ms": 23272}`
...
The summary accurately captures the key details from the original job posting. It includes:
- The role title (CA Intern) and company name (Deutsche Bank Group)
- Location (Mumbai, India)
- Key responsibilities related to analyzing capital adequacy, managing economic capital models, supporting framework enhancements, participating in projects and forums, monitoring regulatory changes, and implementing measures required by supervisors and auditors.
- Requirements such as good knowledge of risk management frameworks, strong project management skills, innovative mindset, proficiency with MS Office, effective communication, analytical skills, time management, passion for change, and eligibility for Industrial Training.

The summary is well-formatted, following the ===OUTPUT TEMPLATE=== format. There are no hallucinated details or omissions from the original posting in the provided summary.
````

**Metadata:** `{"model": "qwen2.5:7b", "latency_ms": 8565}`
...
**Metadata:** `{"model": "gemma2:latest", "latency_ms": 42535}`
...
## ✅ Interaction 6: Check if Skills Exist
...
## ✅ Interaction 7: r1114_extract_skills
...
````
["risk management frameworks", "regulatory models", "economic capital metrics", "MS Office", "Excel", "PowerPoint", "project management", "analytical skills", "business problem-solving", "time management", "communication", "innovative mindset", "proactive", "change management", "ICAAP", "stress testing", "financial regulations", "team player"]
````

**Metadata:** `{"model": "qwen2.5:7b", "latency_ms": 5149}`
...
## ✅ Interaction 8: IHL Analyst - Find Red Flags
...
```json
{
  ...
  "red_flags": [],
  "reasoning": "The job posting does not contain any of the specified red flags and appears to be a genuine intern position."
}
```
...
**Metadata:** `{"model": "qwen2.5:7b", "latency_ms": 3286}`
...
- **Completed:** 8
- **Failed:** 0
- **Total duration:** 88.6s
- **Avg per interaction:** 11.07s
