...
\restrict pYxqMX96hfyD8R1Vju9VgA0fUiM1LFAB2rqOGPkQfdqR0NUhDfXBFhIeAI0DtsQ
...
COMMENT ON TABLE public.skills_pending_taxonomy IS 'Queue of new skills discovered in job postings that need human review for taxonomy inclusion.';
...
ALTER TABLE ONLY public.profile_job_matches
    ADD CONSTRAINT profile_job_matches_profile_id_job_id_key UNIQUE (profile_id, job_id);
...
ALTER TABLE ONLY public.skills_pending_taxonomy
    ADD CONSTRAINT skills_pending_taxonomy_pkey PRIMARY KEY (raw_skill);
...
CREATE INDEX idx_matches_job ON public.profile_job_matches USING btree (job_id);
...
--
-- Name: profile_job_matches profile_job_matches_job_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: base_admin
--

ALTER TABLE ONLY public.profile_job_matches
    ADD CONSTRAINT profile_job_matches_job_id_fkey FOREIGN KEY (job_id) REFERENCES public.postings(job_id) ON DELETE CASCADE;
...
\unrestrict pYxqMX96hfyD8R1Vju9VgA0fUiM1LFAB2rqOGPkQfdqR0NUhDfXBFhIeAI0DtsQ
