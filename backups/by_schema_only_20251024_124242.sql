...
\restrict OBZJuqNndyhSDINaCdGNmCDN83iYShSC5RvU6DVe6hdYkrVCrGzLiDtYGY3vqOA
...
COMMENT ON TABLE public.instruction_branch_executions IS 'Complete workflow audit showing why specific routing decisions were made. SHARED by both testing and production.';
...
CREATE TABLE public.instruction_branches (
    ...
    enabled boolean DEFAULT true,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT instruction_branches_condition_operator_check CHECK ((condition_operator = ANY (ARRAY['contains'::text, 'equals'::text, 'greater_than'::text, 'less_than'::text, 'not_contains'::text]))),
    CONSTRAINT instruction_branches_condition_type_check CHECK ((condition_type = ANY (ARRAY['pattern_match'::text, 'length_check'::text, 'ai_evaluation'::text, 'always'::text])))
);
...
COMMENT ON TABLE public.instruction_branches IS 'Conditional routing for self-correcting workflows. Enables error handling, retry mechanisms, and adaptive routing.';
...
--
-- Name: v_design_hierarchy; Type: VIEW; Schema: public; Owner: base_admin
--

CREATE VIEW public.v_design_hierarchy AS
 SELECT f.facet_id,
   ...
   FROM ((((public.facets f
     LEFT JOIN public.canonicals c ON ((c.facet_id = f.facet_id)))
     LEFT JOIN public.sessions s ON ((s.canonical_code = c.canonical_code)))
     LEFT JOIN public.instructions i ON ((i.session_id = s.session_id)))
     LEFT JOIN public.instruction_branches ib ON ((ib.instruction_id = i.instruction_id)))
  ORDER BY f.facet_id, c.canonical_code, s.session_id, i.step_number, ib.branch_priority;


ALTER TABLE public.v_design_hierarchy OWNER TO base_admin;

--
-- Name: VIEW v_design_hierarchy; Type: COMMENT; Schema: public; Owner: base_admin
--

COMMENT ON VIEW public.v_design_hierarchy IS 'Complete capability hierarchy from facets down to instruction branches. Use for Design View in GUI. Shows what capabilities exist and how to test them.';
...
--
-- Name: recipe_runs recipe_runs_recipe_id_variation_id_batch_id_key; Type: CONSTRAINT; Schema: public; Owner: base_admin
--

ALTER TABLE ONLY public.recipe_runs
    ADD CONSTRAINT recipe_runs_recipe_id_variation_id_batch_id_key UNIQUE (recipe_id, variation_id, batch_id);
...
--
-- Name: idx_instruction_branch_executions_branch; Type: INDEX; Schema: public; Owner: base_admin
--

CREATE INDEX idx_instruction_branch_executions_branch ON public.instruction_branch_executions USING btree (branch_id);


--
-- Name: idx_instruction_branch_executions_instruction_run; Type: INDEX; Schema: public; Owner: base_admin
--

CREATE INDEX idx_instruction_branch_executions_instruction_run ON public.instruction_branch_executions USING btree (instruction_run_id);


--
-- Name: idx_instruction_branches_instruction; Type: INDEX; Schema: public; Owner: base_admin
--

CREATE INDEX idx_instruction_branches_instruction ON public.instruction_branches USING btree (instruction_id);


--
-- Name: idx_instruction_branches_next_step; Type: INDEX; Schema: public; Owner: base_admin
--

CREATE INDEX idx_instruction_branches_next_step ON public.instruction_branches USING btree (next_step_id);
...
--
-- Name: instruction_branch_executions instruction_branch_executions_branch_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: base_admin
--

ALTER TABLE ONLY public.instruction_branch_executions
    ADD CONSTRAINT instruction_branch_executions_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.instruction_branches(branch_id);


--
-- Name: instruction_branch_executions instruction_branch_executions_instruction_run_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: base_admin
--

ALTER TABLE ONLY public.instruction_branch_executions
    ADD CONSTRAINT instruction_branch_executions_instruction_run_id_fkey FOREIGN KEY (instruction_run_id) REFERENCES public.instruction_runs(instruction_run_id);


--
-- Name: instruction_branches instruction_branches_instruction_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: base_admin
--

ALTER TABLE ONLY public.instruction_branches
    ADD CONSTRAINT instruction_branches_instruction_id_fkey FOREIGN KEY (instruction_id) REFERENCES public.instructions(instruction_id);


--
-- Name: instruction_branches instruction_branches_next_step_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: base_admin
--

ALTER TABLE ONLY public.instruction_branches
    ADD CONSTRAINT instruction_branches_next_step_id_fkey FOREIGN KEY (next_step_id) REFERENCES public.instructions(instruction_id);
...
\unrestrict OBZJuqNndyhSDINaCdGNmCDN83iYShSC5RvU6DVe6hdYkrVCrGzLiDtYGY3vqOA
