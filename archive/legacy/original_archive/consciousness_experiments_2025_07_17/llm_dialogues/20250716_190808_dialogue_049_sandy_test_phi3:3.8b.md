...
- Superior skills in management and planning, with an ability to positively influence change within both organizational policies and personal work habits for team development is essential;  
- Strong proficiency required in German (written/spoken) and English. This includes the capability of effectively communicating complex technical information across multilingual audit teams as well as with international regulatory bodies when necessary.
```
