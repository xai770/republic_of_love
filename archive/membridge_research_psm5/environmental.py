...
class EnvironmentalContextCollector:
    ...
    def collect_environmental_context(self) -> Dict[str, Any]:
        """
        Collect current environmental context with non-blocking psutil calls.
        
        Returns environmental metrics without blocking pipeline execution.
        Uses cached values and graceful fallbacks to ensure non-blocking behavior.
        
        Returns:
            Dictionary containing environmental metrics
        """
        try:
...
class DriftDetector:
    ...
    def __init__(self, config_path: Optional[Path] = None):
        self.config_path = config_path or Path("membridge/config/drift.yaml")
    ...
    def get_current_context(self) -> Optional[EnvironmentalContext]:
        ...
        return self.context_collector.collect_environmental_context()
