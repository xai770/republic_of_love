...
A specialist that replicates the two-step extraction process using Ollama's 
Gemma model to extract concise job requirements.

Migrated from Sandy's V7.0 implementation.
...
class GemmaConciseExtractor:
    ...
    Replicates the exact two-step process:
    ...
    def _run_step1_extraction(self, job_description: str) -> Optional[str]:
        """
        Step 1: Initial extraction of requirements and responsibilities
        """
    ...
    def _run_step2_requirements(self, step1_output: str) -> Optional[str]:
        """
        Step 2: Requirements focus with English translation
        """
