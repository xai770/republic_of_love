...
=============================================
Complete rebuild for V3.1 session-based architecture.
...
class SessionAwareRecipeRunner:
    """V3.1 Session-Based Recipe Execution Engine"""
    ...
    def render_prompt_with_parameters(self, template: str, variation_params: Dict[str, str], 
        ...
        # Replace instruction step outputs
    ...
    def execute_recipe_run(self, recipe_run: Dict[str, Any]) -> bool:
        ...
        print(f"Input: {recipe_run['variation_params']['variations_param_1']}")
    ...
    def run_all_pending(self, max_runs: Optional[int] = None, specific_ids: Optional[List[int]] = None) -> Dict[str, int]:
        ...
        print(f"\n{'='*70}")
        print(f"🚀 LLMCORE V3.1 RECIPE RUNNER")
        print(f"{'='*70}")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='LLMCore V3.1 Session-Aware Recipe Test Runner',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  # Run all pending recipe runs
  python recipe_run_test_runner_v31.py
  
  # Run maximum 5 recipe runs
  python recipe_run_test_runner_v31.py --max-runs 5
  
  # Use different database
  python recipe_run_test_runner_v31.py --db /path/to/llmcore.db
        """
    )
