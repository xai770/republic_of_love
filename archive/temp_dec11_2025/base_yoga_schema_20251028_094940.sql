...
\restrict eJ7GsbA1XhXvSkWkdWUt631t7eptZCXLkwX595PTxSYlvQLtiCfz1nX5BPPvv1f
...
CREATE TABLE public.actors (
    ...
    CONSTRAINT actors_actor_type_check CHECK ((actor_type = ANY (ARRAY['human'::text, 'ai_model'::text, 'script'::text])))
);
...
--
-- Name: gershon_profile; Type: TABLE; Schema: public; Owner: base_admin
--

CREATE TABLE public.gershon_profile (
...
ALTER TABLE public.gershon_profile OWNER TO base_admin;

--
-- Name: TABLE gershon_profile; Type: COMMENT; Schema: public; Owner: base_admin
--

COMMENT ON TABLE public.gershon_profile IS 'User profile for job matching. Versioned for historical tracking of skill development. Currently for Gershon, expandable to multi-user for talent.yoga platform.';


--
-- Name: COLUMN gershon_profile.technical_skills; Type: COMMENT; Schema: public; Owner: base_admin
--

COMMENT ON COLUMN public.gershon_profile.technical_skills IS 'JSONB object: {"Python": 5, "SQL": 4, "Docker": 3}. Skill levels 1-5.';


--
-- Name: COLUMN gershon_profile.soft_skills; Type: COMMENT; Schema: public; Owner: base_admin
--

COMMENT ON COLUMN public.gershon_profile.soft_skills IS 'JSONB object: {"Communication": 5, "Leadership": 4}. Skill levels 1-5.';


--
-- Name: COLUMN gershon_profile.languages; Type: COMMENT; Schema: public; Owner: base_admin
--

COMMENT ON COLUMN public.gershon_profile.languages IS 'JSONB object: {"German": "C1", "English": "C2"}. CEFR levels.';
...
--
-- Name: skills; Type: TABLE; Schema: public; Owner: base_admin
--
...
ALTER TABLE public.skills OWNER TO base_admin;

--
-- Name: TABLE skills; Type: COMMENT; Schema: public; Owner: base_admin
--

COMMENT ON TABLE public.skills IS 'Hierarchical skill taxonomy. The heart of SkillBridge - without accurate skill taxonomy, no meaningful job-candidate matching is possible.';


--
-- Name: COLUMN skills.parent_skill_id; Type: COMMENT; Schema: public; Owner: base_admin
--

COMMENT ON COLUMN public.skills.parent_skill_id IS 'Self-referencing hierarchy. NULL = root level (e.g., "Technical Skills"). Allows unlimited depth.';


--
-- Name: COLUMN skills.level; Type: COMMENT; Schema: public; Owner: base_admin
--

COMMENT ON COLUMN public.skills.level IS 'Hierarchy depth: 1=Category (Technical/Soft), 2=Subcategory (Cloud/Programming), 3=Specific (Kubernetes/Python), etc.';


--
-- Name: skills_skill_id_seq; Type: SEQUENCE; Schema: public; Owner: base_admin
--
...
ALTER TABLE public.skills_skill_id_seq OWNER TO base_admin;

--
-- Name: skills_skill_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: base_admin
--
...
--
-- Name: v_language_coverage; Type: VIEW; Schema: public; Owner: base_admin
--

CREATE VIEW public.v_language_coverage AS
 SELECT s.skill_name AS canonical_skill,
    s.skill_id,
   ...
   FROM (public.skills s
     LEFT JOIN public.skill_synonyms ss ON ((s.skill_id = ss.canonical_skill_id)))
  GROUP BY s.skill_id, s.skill_name
  ORDER BY (count(DISTINCT ss.language)) DESC, (count(ss.synonym_id)) DESC;


ALTER TABLE public.v_language_coverage OWNER TO base_admin;

--
-- Name: VIEW v_language_coverage; Type: COMMENT; Schema: public; Owner: base_admin
--

COMMENT ON VIEW public.v_language_coverage IS 'Shows which skills have multi-language synonym support. Target: all critical skills covered in top 5 languages (en, de, fr, es, zh).';
...
--
-- Name: v_skill_hierarchy; Type: VIEW; Schema: public; Owner: base_admin
--
...
CREATE VIEW public.v_skill_hierarchy AS
 WITH RECURSIVE skill_tree AS (
         SELECT skills.skill_id,
            ...
            skills.level,
            skills.skill_name AS skill_path,
            ARRAY[skills.skill_id] AS skill_path_ids
           FROM public.skills
          WHERE (skills.parent_skill_id IS NULL)
        UNION ALL
         SELECT s.skill_id,
            s.skill_name,
            s.parent_skill_id,
            s.level,
            ((st.skill_path || ' → '::text) || s.skill_name),
            (st.skill_path_ids || s.skill_id)
           FROM (public.skills s
             JOIN skill_tree st ON ((s.parent_skill_id = st.skill_id)))
        )
 SELECT skill_tree.skill_id,
    skill_tree.skill_name,
    skill_tree.parent_skill_id,
    skill_tree.level,
    skill_tree.skill_path,
    skill_tree.skill_path_ids
   FROM skill_tree
  ORDER BY skill_tree.skill_path;


ALTER TABLE public.v_skill_hierarchy OWNER TO base_admin;

--
-- Name: VIEW v_skill_hierarchy; Type: COMMENT; Schema: public; Owner: base_admin
--

COMMENT ON VIEW public.v_skill_hierarchy IS 'Flattened skill hierarchy with full paths. Example: "Technical Skills → Cloud Infrastructure → Container Orchestration → Kubernetes"';
...
--
-- Name: skills skill_id; Type: DEFAULT; Schema: public; Owner: base_admin
--
...
--
-- Name: gershon_profile gershon_profile_pkey; Type: CONSTRAINT; Schema: public; Owner: base_admin
--

ALTER TABLE ONLY public.gershon_profile
...
--
-- Name: skills skills_pkey; Type: CONSTRAINT; Schema: public; Owner: base_admin
--
...
--
-- Name: skills skills_skill_name_key; Type: CONSTRAINT; Schema: public; Owner: base_admin
--
...
--
-- Name: idx_skills_enabled; Type: INDEX; Schema: public; Owner: base_admin
--
...
--
-- Name: idx_skills_level; Type: INDEX; Schema: public; Owner: base_admin
--

CREATE INDEX idx_skills_level ON public.skills USING btree (level);


--
-- Name: idx_skills_name_lower; Type: INDEX; Schema: public; Owner: base_admin
--

CREATE INDEX idx_skills_name_lower ON public.skills USING btree (lower(skill_name));


--
-- Name: idx_skills_parent; Type: INDEX; Schema: public; Owner: base_admin
--
...
ALTER TABLE ONLY public.profile_skills
    ADD CONSTRAINT profile_skills_skill_id_fkey FOREIGN KEY (skill_id) REFERENCES public.skills(skill_id);
...
--
-- Name: skill_inference_rules skill_inference_rules_inferred_skill_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: base_admin
--

ALTER TABLE ONLY public.skill_inference_rules
    ADD CONSTRAINT skill_inference_rules_inferred_skill_id_fkey FOREIGN KEY (inferred_skill_id) REFERENCES public.skills(skill_id);


--
-- Name: skill_inference_rules skill_inference_rules_source_skill_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: base_admin
--

ALTER TABLE ONLY public.skill_inference_rules
    ADD CONSTRAINT skill_inference_rules_source_skill_id_fkey FOREIGN KEY (source_skill_id) REFERENCES public.skills(skill_id);
...
--
-- Name: skill_synonyms skill_synonyms_canonical_skill_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: base_admin
--

ALTER TABLE ONLY public.skill_synonyms
    ADD CONSTRAINT skill_synonyms_canonical_skill_id_fkey FOREIGN KEY (canonical_skill_id) REFERENCES public.skills(skill_id);


--
-- Name: skills skills_parent_skill_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: base_admin
--

ALTER TABLE ONLY public.skills
    ADD CONSTRAINT skills_parent_skill_id_fkey FOREIGN KEY (parent_skill_id) REFERENCES public.skills(skill_id);
...
\unrestrict eJ7GsbA1XhXvSkWkdWUt631t7eptZCXLkwX595PTxSYlvQLtiCfz1nX5BPPvv1f
